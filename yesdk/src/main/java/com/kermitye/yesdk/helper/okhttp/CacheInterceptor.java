...
import com.kermitye.yesdk.utils.HttpUtils;
import com.kermitye.yesdk.utils.NetworkConnectionUtils;
...
public class CacheInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (NetworkConnectionUtils.isNetworkConnected(BaseApplication.getContext())) {
            // 有网络时, 缓存1小时
            int maxAge = 60 * 60;
